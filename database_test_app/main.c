...
enum mode { MODE_ONLY_INSERTS, MODE_ONLY_SELECTS, MODE_ALL };
...
int test1(int argc, char **argv) {
  ...
  } else if (strcmp(argv[1], "MODE_ONLY_SELECTS") == 0) {
  ...
  struct database_table posts_table =
      mode == MODE_ONLY_SELECTS
          ? database_get_table_with_name(database, "Posts").table
          : create_posts_table(database);
